...
public class assignment2P3 extends GraphicsProgram {
	...
	private void buildRightRect() {
		...
		add(rightLabel, gW / 2 - RECT_WIDTH / 2 + SPACE_BETWEENREC + (RECT_WIDTH - RL1) / 2,
				gH / 5 + MIDLINE_WIDTH + RECT_HEIGHT / 2 + RL2 / 2);
	}
	...
	private void buildLeftRect() {
		...
		add(leftLabel, gW / 2 - RECT_WIDTH / 2 - SPACE_BETWEENREC + (RECT_WIDTH - LL1) / 2,
				gH / 5 + MIDLINE_WIDTH + RECT_HEIGHT / 2 + LL2 / 2);
	}
